...
const Skills = () => {
    ...
    const [currentLsDate, setCurrentLsDate] = useState<string>('--- -- ----');
    ...
    useEffect(() => {
        const updateDate = () => {
            setCurrentLsDate(formatLsDate(new Date()));
        };
                        ...
                        <Terminal title="devcix@tech:~/skills">
                            <div className="space-y-2">
                                ...
                                <div className="ml-4 text-dracula-comment text-sm space-y-1">
                                    <div>total 24</div>
                                    <div>drwxr-xr-x 3 devcix devcix 4096 {currentLsDate} .</div>
                                    <div>drwxr-xr-x 3 devcix devcix 4096 {currentLsDate} ..</div>
                                    {skillsData.map((skill, idx) => (
                                        ...
                                        >
                                            -rw-r--r-- 1 devcix devcix 512 {currentLsDate} {skill.command}
                                        </motion.div>
                                    ))}
                                </div>
