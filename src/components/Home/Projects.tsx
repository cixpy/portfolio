...
export const Projects = ({ projects }: ProjectsProps) => {
    ...
    return (
        <section className="py-8 px-2 md:px-6">
            <motion.div
                initial="hidden"
                whileInView="visible"
            ...
            >
                ...
                <p className="text-center text-dracula-comment max-w-2xl mx-auto mb-8">
                    click on each card to see details, links, and preview
                </p>
